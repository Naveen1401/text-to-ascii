...
//       copyToC
//   copy_btn.addEventListener('click', () => {
//       copyToClipboard(document.querySelector("#results2").innerHTML)
//     })
...
$(document).ready(function () {
    ...
    $(document).bind('##RENDER_ASCII_ART##', function (e) {
        Figlet.write($('#theCode').val(), $('#fontSelector').val(), function (str) {
            debug.log(str);
            // console.log(str);
            $('#asciiArt').html('<textarea id="outputText" value wrap = "off" name="output">' + str + '</textarea>');
        });
    });
